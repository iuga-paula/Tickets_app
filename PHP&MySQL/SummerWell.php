...
<form action =  "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method = "post">
    ...
    <label><b>Tickets type</b></label>
        ...
        <option>One day 13 Aug - 50 euro</option>
        <option>One day 14 Aug - 50 euro</option>
        <option>Full entrance - 100 euro</option>
        </select>
    </div>
...
<div class="col-md-6 ">
<p id = "par1">Thank, you! Your tickets have been <span id = "sp"> succesfully </span> booked.</p>
</div>
</div>
</body>
</html>